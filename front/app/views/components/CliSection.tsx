  ...
  const cliFeatures = [
    {
      ...
      icon: Shield,
      command: "skipy password generate -l 16 -u -d -n -s",
    ...
    },
    {
      ...
      icon: QrCode,
      command: 'skipy qr generate "https://example.com"',
      color: "text-blue-600",
    },
    {
      name: "JWT Manager",
      ...
      icon: Key,
      command: 'skipy jwt create --payload \'{"user":"john"}\'',
    ...
    },
    {
      ...
      icon: Database,
      command: "skipy fake user --count 5",
    ...
    },
    {
      ...
      icon: Link,
      command: 'skipy url shorten "https://example.com/long-url"',
      color: "text-cyan-600",
    },
    {
      ...
      icon: Palette,
      command: 'skipy palette --base "#3498db"',
      color: "text-pink-600",
    },
  ];

...
interface UnShortenedURLDisplayProps {
  originalUrl: string;
  copiedMessage: string;
  copyToClipboard: () => void;
}

const UnShortenedURLDisplay: React.FC<UnShortenedURLDisplayProps> = ({
  originalUrl,
  copiedMessage,
  copyToClipboard,
}) => (
      ...
      <div className="relative mt-6 w-full flex flex-col rounded-xl bg-white items-center  bg-clip-border text-gray-700 shadow-md">
        <div className="p-6">
          ...
          <a
            href={originalUrl}
            target="_blank"
            className="block font-sans text-black  text-base font-light leading-relaxed text-inherit antialiased"
          >
            {originalUrl}
          </a>
        </div>
...
export default UnShortenedURLDisplay;
